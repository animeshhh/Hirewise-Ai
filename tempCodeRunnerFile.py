...
# Load dataset
df = pd.read_csv('/Users/animeshpandey/Downloads/archive/Resume/Resume.csv')  # <-- Make sure path is correct

# Generate mock performance scores (1-100)
np.random.seed(42)
...
def extract_features(resume):
    ...
    skill_keywords = ['python', 'java', 'machine learning', 'sql', 'tableau']
    ...
    skills_count = sum(1 for word in skill_keywords if word in text)
    ...
    return [edu_count, exp_count, skills_count, total_exp, certs_flag]
